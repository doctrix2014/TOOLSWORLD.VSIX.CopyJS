//------------------------------------------------------------------------------
// <copyright file="CopyJSFile.cs" company="Company">
...
namespace TOOLSWORLD.VSIX.CopyJS
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class CopyJSFile
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("0103c58f-59de-4ed7-a799-cd92ae4e245b");
        ...
        private CopyJSFile(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static CopyJSFile Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new CopyJSFile(package);
        }
        ...
        private void CopyFile(string file, string dest)
        {
